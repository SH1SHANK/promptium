...
!(function (e, r) {
    ...
    F = function (e, r, t) {
      ...
      for (i++, 40 === s && (s = 41); i < t; ) {
        if ((n = e.charCodeAt(i)) === s)
          return ((a.pos = i + 1), (a.lines = o), (a.str = q(e.slice(r + 1, i))), (a.ok = !0), a);
            ...
            if (_)
              for (k = v.length - 1; k >= 0 && ((l = v[k]), !(v[k].level < c)); k--)
                if (l.single === b && v[k].level === c) {
                  ((l = v[k]),
                    b
                      ? ((y = r.md.options.quotes[2]), (C = r.md.options.quotes[3]))
                      : ((y = r.md.options.quotes[0]), (C = r.md.options.quotes[1])),
                ...
                a = e.sCount[p] + 1,
                  32 === e.src.charCodeAt(w)
                    ...
                    : 9 === e.src.charCodeAt(w)
                      ? ((b = !0), (e.bsCount[p] + a) % 4 == 3 ? (w++, a++, (s = !1)) : (s = !0))
                      : (b = !1),
                  h = a,
                  f.push(e.bMarks[p]),
                  e.bMarks[p] = w;
      ...
      [
        ...
        function (e, r, t, n) {
          var s,
            ...
            T = !0;
          if (e.sCount[L] - e.blkIndent >= 4) return !1;
          if (e.listIndent >= 0 && e.sCount[L] - e.listIndent >= 4 && e.sCount[L] < e.blkIndent)
            return !1;
          if (
            (n && 'paragraph' === e.parentType && e.sCount[L] >= e.blkIndent && (z = !0),
            (w = ke(e, L)) >= 0)
          ) {
            if (
              ((u = !0),
          ...
          for (
            ...
            for (
              x = w, _ = e.eMarks[L], l = k = e.sCount[L] + w - (e.bMarks[L] + e.tShift[L]);
              x < _;
            ) {
            ...
            if (
              ((c = (o = x) >= _ ? 1 : k - l) > 4 && (c = 1),
              (a = l + c),
              ((F = e.push('list_item_open', 'li', 1)).markup = String.fromCharCode(m)),
              (F.map = p = [L, 0]),
              ...
              (e.sCount[L] = y),
              (e.tight = A),
              ((F = e.push('list_item_close', 'li', -1)).markup = String.fromCharCode(m)),
              (L = e.line),
              (p[1] = L),
              L >= t)
            )
        ...
        function (e, r, t, n) {
          ...
          return (
            ...
            (n ||
              ...
              (i = e.skipCharsBack(l, 35, c)) > c && De(e.src.charCodeAt(i - 1)) && (l = i),
              (e.line = r + 1),
  ...
  ((Le.prototype.tokenize = function (e, r, t) {
    for (
      ...
      c < t && ((e.line = c = e.skipEmptyLines(c)), !(c >= t)) && !(e.sCount[c] < e.blkIndent);
    ) {
      if (e.level >= u) {
        e.line = t;
        break;
  ...
  function vr(e) {
    ...
    var i = Object.keys(e.__compiled__)
      ...
      .map(mr)
      .join('|');
    ((e.re.schema_test = RegExp('(^|(?!_)(?:[><\uff5c]|' + r.src_ZPCc + '))(' + i + ')', 'i')),
      (e.re.schema_search = RegExp('(^|(?!_)(?:[><\uff5c]|' + r.src_ZPCc + '))(' + i + ')', 'ig')),
  ...
  ((Ar.prototype.add = function (e, r) {
    ...
    (Ar.prototype.match = function (e) {
      ...
      for (var n = r ? e.slice(r) : e; this.test(n); )
        (t.push(Cr(this, r)), (n = n.slice(this.__last_index__)), (r += this.__last_index__));
      ...
      return (
        ...
        r
          ? ((this.__tlds__ = this.__tlds__
            ...
            vr(this),
            this)
          : ((this.__tlds__ = e.slice()), (this.__tlds_replaced__ = !0), vr(this), this)
      );
    }),
  ...
  function $r(e) {
    return Ur(e, function (e) {
      var r = '';
      return (
        e > 65535 && ((r += Pr((((e -= 65536) >>> 10) & 1023) | 55296)), (e = 56320 | (1023 & e))),
        (r += Pr(e))
      );
    }).join('');
  }
  ...
  function Wr(e) {
    ...
    for (n = s = g.length, s && g.push(Tr); n < h; ) {
      ...
      for (
        a - r > Or((wr - t) / (f = n + 1)) && jr('overflow'), t += (a - r) * f, r = a, i = 0;
        i < h;
        ++i
      )
        if (((p = e[i]) < r && ++t > wr && jr('overflow'), p == r)) {
          for (c = t, l = Dr; !(c < (u = l <= o ? Er : l >= o + qr ? qr : l - o)); l += Dr)
            ((m = c - u), (d = Dr - u), g.push(Pr(Gr(u + (m % d), 0))), (c = Or(m / d)));
  ...
  var Qr = '1.4.1',
    ...
    et = { version: Qr, ucs2: Xr, toASCII: Kr, toUnicode: Yr, encode: Wr, decode: Jr },
    rt = e(
      Object.freeze({
        __proto__: null,
        decode: Jr,
