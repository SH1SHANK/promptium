...
const MODELS_DB: Record<string, ModelGuidance> = {
  ...
  claude: {
    ...
    preferredStyle: "XML tags (`<context>`, `<instructions>`, `<example>`) for structured arguments.",
    formattingRecommendations: [
